...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionalCenter.state'
        db.add_column('catalog_regionalcenter', 'state',
                      self.gf('django.contrib.localflavor.us.models.USStateField')(default='', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionalCenter.state'
        db.delete_column('catalog_regionalcenter', 'state')
