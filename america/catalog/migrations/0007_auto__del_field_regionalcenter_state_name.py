...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'RegionalCenter.state_name'
        raise RuntimeError("Cannot reverse this migration. 'RegionalCenter.state_name' and its values cannot be restored.")
